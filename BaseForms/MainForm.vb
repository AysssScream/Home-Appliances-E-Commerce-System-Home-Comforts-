...
Public Class MainForm
    ...
    Public Sub New()
        ...
        DesktopPanel.BackColor = Colors.whiteSecondary
    ...
    Private Sub LoadUserMenu()
        If Project.Instance.ActiveAccountType = "Cashier" Then
            ...
            OpenChildForm("Cashier", "Cashier")
        Else
            Me.SideMenuPanel.Visible = True
            OpenChildForm("Dashboard", "Dashboard")
        End If
    End Sub
    ...
    Public Sub OpenChildForm(FormName As String, FormCaption As String)
        ...
        Else
            ...
            If Not FormCaption.Contains("Lists") Then
